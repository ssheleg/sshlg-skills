...
const LANES = [
  ...
  { id: 'implement', asks: 'the quality of the code that renders it', owner: null },
  { id: 'mobile', asks: 'React Native and Expo surfaces', owner: null },
  { id: 'verify', asks: 'what it actually looks like in a browser', owner: null },
  { id: 'a11y', asks: 'whether it can be used at all', owner: null },
  { id: 'speed', asks: 'how fast the thing they land on is', owner: 'sheleg-dev' },
  { id: 'handoff', asks: 'what a developer receives, and how it is checked', owner: null },
];
...
function checkReport(results) {
  ...
  for (const r of rows) {
    let verdict;
    if (r.error) verdict = `unreachable (${r.error})`;
...
module.exports = {
  ...
  assertPack, presence, report, index, checkReport, readSkills,
};
