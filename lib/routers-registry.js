 ...
 * three routers that is survivable; at nine it is a scheduled bug. An entry
 ...
 *
 * The place-sentence names only NEIGHBOURS, never the full list: with nine
 * routers an enumeration in every text is nine copies of one ordering, and
...
const SHELEG_DEV = `**If \`sheleg-dev\` is installed, the integration layer under a paid product
...
happened (\`ad-tracking\`), signing a person in (\`google-signin\`,
 ...
 *
 * Order: the first six say what the change CONTAINS, the seventh how it
