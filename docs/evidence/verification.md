...
| AW-8 | Eight members re-pinned at registry-confirmed releases | `npm view`: `@ssheleg/sheleg-dev` 0.11.8, `@ssheleg/make-skill` 0.27.1, `super-ux` 0.55.1, `agent-stack` 0.23.2, `@ssheleg/seo-aeo-audit` 0.25.11, `@ssheleg/agent-sync` 1.19.3, `task-pipeline-skill` 1.85.1, `sheleg-design-skill` 1.59.4; telegram-dev audited clean, unmoved | v1.46.0 | a pin moved without its registry read | verified |
