...
## Dated run records, rotated 2026-08-30 (UM-01)

Moved here from `docs/evidence/retro.md` verbatim — every heading, id, citation
and byte unchanged (SHA-256 of everything below this paragraph:
`5bc1106a3905468c340aae101a07c6748b2fdc5a8bb0588e19c03edef1a4d848`).
The Run stamps table in `retro.md` remains the index; where a stamp row says
*"yes — see below"*, below is here. These records stay frozen: rows cite member
repositories and states that were true at a commit, and rewriting those is a
thing this repository has already decided against.
