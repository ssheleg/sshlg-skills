# FIX-VD-03 — Mobile/native ветка не завершена платформенным адаптером, а общий product default остаётся вебовым

P1 · очередь 1 · расчётная волна 6 · planned_not_implemented
...
В Nicegram web concept C01--ready виден HTML select; source действительно содержит select и14px. Это подтверждённое расхождение web fixture с загруженным 16px rule, но zoom-on-focus на реальном Safari здесь не воспроизводился. Native runtime, Dynamic Type и VoiceOver в VERIFICATION честно исключены. Само использование HTML для browser prototype не является ошибкой и shadcn/workbench в Nicegram не применялись.

- [repo://sheleg-design/plugins/sheleg-design/skills/sheleg-design/MOBILE_SURFACES.md:20](https://github.com/ssheleg/sheleg-design-skill/blob/562786b30f07f50a294d70a4c3ffd40794624f42/plugins/sheleg-design/skills/sheleg-design/MOBILE_SURFACES.md#L20)
- [repo://sheleg-design/plugins/sheleg-design/skills/sheleg-design/MOBILE_SURFACES.md:76](https://github.com/ssheleg/sheleg-design-skill/blob/562786b30f07f50a294d70a4c3ffd40794624f42/plugins/sheleg-design/skills/sheleg-design/MOBILE_SURFACES.md#L76)
- [repo://sheleg-design/plugins/sheleg-design/skills/sheleg-design/SKILL.md:228](https://github.com/ssheleg/sheleg-design-skill/blob/562786b30f07f50a294d70a4c3ffd40794624f42/plugins/sheleg-design/skills/sheleg-design/SKILL.md#L228)
- [repo://sshlg-skills/lib/packs.js:76](https://github.com/ssheleg/sshlg-skills/blob/7ef37e8bd5220d6ab355346634ff19196de8f41b/lib/packs.js#L76)
- [repo://sheleg-design/plugins/sheleg-design/skills/sheleg-design/AI_PRODUCT_PATTERNS.md:7](https://github.com/ssheleg/sheleg-design-skill/blob/562786b30f07f50a294d70a4c3ffd40794624f42/plugins/sheleg-design/skills/sheleg-design/AI_PRODUCT_PATTERNS.md#L7)
- [repo://sheleg-design/plugins/sheleg-design/skills/sheleg-design/AI_PRODUCT_PATTERNS.md:111](https://github.com/ssheleg/sheleg-design-skill/blob/562786b30f07f50a294d70a4c3ffd40794624f42/plugins/sheleg-design/skills/sheleg-design/AI_PRODUCT_PATTERNS.md#L111)
- [repo://sheleg-design/plugins/sheleg-design/skills/sheleg-design/MOBILE_SURFACES.md:41](https://github.com/ssheleg/sheleg-design-skill/blob/562786b30f07f50a294d70a4c3ffd40794624f42/plugins/sheleg-design/skills/sheleg-design/MOBILE_SURFACES.md#L41)
- [machine-snapshot://DATA/nicegram-assistant-preview/public/inchat.css:1](machine-snapshot://DATA/nicegram-assistant-preview/public/inchat.css:1)
- [machine-snapshot://DATA/nicegram-assistant-preview/public/inchat.js:54](machine-snapshot://DATA/nicegram-assistant-preview/public/inchat.js:54)
