# FIX-PF-05.01 — Immutable packet compilation
...
75:           "type": "string",
76:           "pattern": "^N-[0-9]{3,}$",
77:           "description": "Addressable, so a verdict, a board row and a commit can all cite the same node."
78:         },
79:         "title": {
80:           "type": "string",
```
...
Тестовый artifact: `repo://task-pipeline/test/audit_regressions/fix-pf-05.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Собрать REQ/global constraints/interfaces/artifact digests/base/scope/budget/profile/skill lock, без ephemeral secrets.
...
Fresh packet содержит every required constraint; missing required ref reject.
...
Appendix и полный parent contract: [leaf JSON](FIX-PF-05.01.json), [parent](../parents/FIX-PF-05.json). Полный audit не required prompt input.
