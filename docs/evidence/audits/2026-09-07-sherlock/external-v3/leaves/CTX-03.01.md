# CTX-03.01 — Bounded scenario graph
...
### Create `repo://super-ux/plugins/super-ux/skills/references/interactive-flow-prototypes.md`
...
Тестовый artifact: `repo://super-ux/test/audit_regressions/ctx-03.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Scenario/screen/transition IDs with happy/error/recovery/back/cancel/returning/external states.
...
Every declared transition has origin/action/result; dangling state detected.
...
Appendix и полный parent contract: [leaf JSON](CTX-03.01.json), [parent](../parents/CTX-03.json). Полный audit не required prompt input.
