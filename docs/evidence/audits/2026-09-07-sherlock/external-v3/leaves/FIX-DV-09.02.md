# FIX-DV-09.02 — One-time OAuth state
...
Тестовый artifact: `repo://sheleg-dev/test/audit_regressions/fix-dv-09.02.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Server-bound random state с TTL и atomic consume, проверять до exchange.
...
- `FIX-DV-09.01` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](FIX-DV-09.02.json), [parent](../parents/FIX-DV-09.json). Полный audit не required prompt input.
