# FIX-PF-02.02 — Revision invalidation
...
Тестовый artifact: `repo://task-pipeline/test/audit_regressions/fix-pf-02.02.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. REQ/interface/brief change создаёт superseding revision и инвалидирует затронутые downstream receipts.
...
Изменение upstream не оставляет descendant certified, unrelated nodes сохраняют valid proof.

Positive и исходный failure case проверяются по поведению, не по повторению слов инструкции.

## Входы и handoff

- `FIX-PF-02.01` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](FIX-PF-02.02.json), [parent](../parents/FIX-PF-02.json). Полный audit не required prompt input.
