# FIX-UP-06.02 — Selection aggregation
...
Тестовый artifact: `repo://super-ux/test/audit_regressions/fix-up-06.02.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Агрегировать только required selected operations; optional router offer не меняет install result.
...
Mixed selection PARTIAL с конкретными failures, no overall success при failed required.

Positive и исходный failure case проверяются по поведению, не по повторению слов инструкции.

## Входы и handoff

- `FIX-UP-06.01` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](FIX-UP-06.02.json), [parent](../parents/FIX-UP-06.json). Полный audit не required prompt input.
