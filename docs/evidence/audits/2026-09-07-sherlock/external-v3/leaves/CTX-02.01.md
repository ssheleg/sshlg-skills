# CTX-02.01 — Finding-to-parent mapper
...
### Create `repo://task-pipeline/plugins/task-pipeline/skills/task-pipeline/scripts/context_packets.py`
...
Тестовый artifact: `repo://task-pipeline/test/audit_regressions/ctx-02.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Stable finding→parent IDs, evidence/limits/priority separate from status; no dropped findings.
...
119 original parents preserved, repeated compile deterministic IDs.
...
Appendix и полный parent contract: [leaf JSON](CTX-02.01.json), [parent](../parents/CTX-02.json). Полный audit не required prompt input.
