# FIX-MS-02.01 — Dependency-free YAML subset
...
Тестовый artifact: `repo://make-skill/test/audit_regressions/fix-ms-02.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Выбрать строгий stdlib precheck явно описанного subset. Duplicate keys и неизвестные scalar forms не принимать; full YAML compliance не обещать.
...
Numeric/bool/null сохраняют тип либо UNSUPPORTED, не превращаются молча в строки.
...
Appendix и полный parent contract: [leaf JSON](FIX-MS-02.01.json), [parent](../parents/FIX-MS-02.json). Полный audit не required prompt input.
