# FIX-TG-03.02 — Strict input boundaries
...
Тестовый artifact: `repo://telegram-dev/test/audit_regressions/fix-tg-03.02.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Отклонять duplicate fields, invalid parse и auth_date вне upper/lower window.
...
- `FIX-TG-03.01` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](FIX-TG-03.02.json), [parent](../parents/FIX-TG-03.json). Полный audit не required prompt input.
