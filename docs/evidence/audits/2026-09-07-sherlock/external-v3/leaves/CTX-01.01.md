# CTX-01.01 — Packet and context schemas
...
### Create `repo://task-pipeline/plugins/task-pipeline/skills/task-pipeline/execution-packet.schema.json`
...
Тестовый artifact: `repo://task-pipeline/test/audit_regressions/ctx-01.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Create ExecutionPacket/ContextRef with version/id/parent/module/decision refs/inputs/source scope/budgets; dependency-free runtime validation.
...
Unknown mandatory major, missing ref/digest or unbound decision reject; valid round-trip.
...
Appendix и полный parent contract: [leaf JSON](CTX-01.01.json), [parent](../parents/CTX-01.json). Полный audit не required prompt input.
