# CTX-02.04 — Pre-dispatch freshness and budget
...
Тестовый artifact: `repo://task-pipeline/test/audit_regressions/ctx-02.04.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Materialize prerequisite outputs/current source, enforce configured primary budget, capability and resource ownership.
...
Source drift/oversized mandatory context/missing upstream prevents claim; no silent truncation.

Positive и исходный failure case проверяются по поведению, не по повторению слов инструкции.

## Входы и handoff

- `CTX-02.03` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](CTX-02.04.json), [parent](../parents/CTX-02.json). Полный audit не required prompt input.
