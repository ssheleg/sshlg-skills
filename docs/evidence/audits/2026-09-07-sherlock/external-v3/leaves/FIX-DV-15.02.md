# FIX-DV-15.02 — SDK channel coverage
...
Тестовый artifact: `repo://sheleg-dev/test/audit_regressions/fix-dv-15.02.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Явно перечислить hooks для logs/attachments/transactions; unsupported channel unknown, не обещание universal scrub.
...
Secret fixtures прогоняются по каждому заявленному channel; bypass channel не зелёный.

Positive и исходный failure case проверяются по поведению, не по повторению слов инструкции.

## Входы и handoff

- `FIX-DV-15.01` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](FIX-DV-15.02.json), [parent](../parents/FIX-DV-15.json). Полный audit не required prompt input.
