# CTX-03.02 — Clickable flow fixture
...
### Create `repo://super-ux/test/fixtures/interactive-flow/index.html`
...
Тестовый artifact: `repo://super-ux/test/audit_regressions/ctx-03.02.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Local HTML fixture with screen map, scenario selector/reset/deep link and labelled simulation, no external SDK.
...
Controls traverse intended states; fake payment/auth never calls live service.

Positive и исходный failure case проверяются по поведению, не по повторению слов инструкции.

## Входы и handoff

- `CTX-03.01` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](CTX-03.02.json), [parent](../parents/CTX-03.json). Полный audit не required prompt input.
