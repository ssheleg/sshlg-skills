# FIX-UP-05.01 — Transaction writer contract
...
Тестовый artifact: `repo://sshlg-skills/test/audit_regressions/fix-up-05.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Same-filesystem sibling stage → manifest/digest verify → journal → atomic switch → previous generation; unknown user files preserve.
...
Copy/rename fault leaves old complete или new verified, never half install.
...
Appendix и полный parent contract: [leaf JSON](FIX-UP-05.01.json), [parent](../parents/FIX-UP-05.json). Полный audit не required prompt input.
