# FIX-SY-03.01 — One local ownership critical section
...
Тестовый artifact: `repo://agent-sync/test/audit_regressions/fix-sy-03.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Local acquire/renew/release/steal используют один OS-backed lock и generation; OS unsupported → explicit unsupported, не unlocked fallback.
...
Concurrent steal/renew сериализуются; partial read не двойной owner.
...
Appendix и полный parent contract: [leaf JSON](FIX-SY-03.01.json), [parent](../parents/FIX-SY-03.json). Полный audit не required prompt input.
