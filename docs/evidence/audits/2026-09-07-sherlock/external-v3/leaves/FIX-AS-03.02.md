# FIX-AS-03.02 — Temporal evidence lifecycle
...
Тестовый artifact: `repo://agent-stack/test/audit_regressions/fix-as-03.02.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Self-generated retrieval не confirmation; supersession reversible, volatile facts имеют freshness даже verified.
...
Повторный retrieval не повышает confidence; новая dated fact сохраняет историю замены.

Positive и исходный failure case проверяются по поведению, не по повторению слов инструкции.

## Входы и handoff

- `FIX-AS-03.01` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](FIX-AS-03.02.json), [parent](../parents/FIX-AS-03.json). Полный audit не required prompt input.
