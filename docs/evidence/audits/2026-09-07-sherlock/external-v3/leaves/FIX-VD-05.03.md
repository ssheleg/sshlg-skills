# FIX-VD-05.03 — Generated kit propagation
...
Тестовый artifact: `repo://sheleg-design/test/audit_regressions/fix-vd-05.03.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Изменить canonical spine/generator и синхронизировать все39 kits механически; representative DOM test плюс structural parity.
...
39 copies согласованы; не нужно39полных app builds; one representative catches actual semantics.

Positive и исходный failure case проверяются по поведению, не по повторению слов инструкции.

## Входы и handoff

- `FIX-VD-05.01` (data): Propagate accepted Button/Heading contract.
- `FIX-VD-05.02` (data): Propagate accepted Button/Heading contract.
...
Appendix и полный parent contract: [leaf JSON](FIX-VD-05.03.json), [parent](../parents/FIX-VD-05.json). Полный audit не required prompt input.
