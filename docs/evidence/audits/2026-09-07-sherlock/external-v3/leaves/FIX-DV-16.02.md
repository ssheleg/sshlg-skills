# FIX-DV-16.02 — Cross-pack recovery agreement
...
Тестовый artifact: `repo://sheleg-dev/test/audit_regressions/fix-dv-16.02.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Error-tracking и telegram-userbots используют один contract; supervisor restart только recoverable policy.
...
Одинаковое revoked событие не получает противоположные действия в двух skills.

Positive и исходный failure case проверяются по поведению, не по повторению слов инструкции.

## Входы и handoff

- `FIX-DV-16.01` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](FIX-DV-16.02.json), [parent](../parents/FIX-DV-16.json). Полный audit не required prompt input.
