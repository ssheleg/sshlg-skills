# FIX-AS-09.01 — Extensible OTel fields
...
Тестовый artifact: `repo://agent-stack/test/audit_regressions/fix-as-09.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Well-known values не closed enum; version/schema revision/observation date сохранять.
...
Новое provider значение не silently dropped, неизвестное сохраняет raw value.
...
Appendix и полный parent contract: [leaf JSON](FIX-AS-09.01.json), [parent](../parents/FIX-AS-09.json). Полный audit не required prompt input.
