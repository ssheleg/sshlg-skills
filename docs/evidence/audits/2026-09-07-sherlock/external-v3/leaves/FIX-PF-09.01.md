# FIX-PF-09.01 — Authenticated publication
...
Тестовый artifact: `repo://fabric/test/audit_regressions/fix-pf-09.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. publishResult требует authenticated owner/run/node/attempt/fence/output schema; проверка и append атомарны в Fabric authority.
...
Чужой/stale attempt не публикует result, current owner accepted.
...
Appendix и полный parent contract: [leaf JSON](FIX-PF-09.01.json), [parent](../parents/FIX-PF-09.json). Полный audit не required prompt input.
