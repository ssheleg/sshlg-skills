# FIX-TP-03.02 — Profile-only gate dispatch
...
Тестовый artifact: `repo://task-pipeline/test/audit_regressions/fix-tp-03.02.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Компилировать выбранный profile один раз и исполнять только его declared gates; unknown mandatory capability блокировать.
...
Custom profile не получает hidden stage0/7/10, но не обходит evidence.

Positive и исходный failure case проверяются по поведению, не по повторению слов инструкции.

## Входы и handoff

- `FIX-TP-03.01` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](FIX-TP-03.02.json), [parent](../parents/FIX-TP-03.json). Полный audit не required prompt input.
