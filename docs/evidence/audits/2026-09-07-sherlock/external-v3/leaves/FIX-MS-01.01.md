# FIX-MS-01.01 — Honest token result
...
Тестовый artifact: `repo://make-skill/test/audit_regressions/fix-ms-01.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Новый обязательный tokenizer dependency не добавлять. Обнаруживать установленный именованный tokenizer через optional adapter; иначе UNMEASURED, estimate отдельно.
...
Без adapter нет token PASS; byte/char estimate не называется tokens.
...
Appendix и полный parent contract: [leaf JSON](FIX-MS-01.01.json), [parent](../parents/FIX-MS-01.json). Полный audit не required prompt input.
