# FIX-DV-07.01 — Opaque browser session
...
Тестовый artifact: `repo://sheleg-dev/test/audit_regressions/fix-dv-07.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Cookie хранит случайный session id; Google credentials доступны server-side только по session+principal.
...
Cookie/redirect/response body не содержат client_secret или refresh_token.
...
Appendix и полный parent contract: [leaf JSON](FIX-DV-07.01.json), [parent](../parents/FIX-DV-07.json). Полный audit не required prompt input.
