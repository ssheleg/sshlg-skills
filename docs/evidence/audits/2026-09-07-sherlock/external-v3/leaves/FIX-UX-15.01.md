# FIX-UX-15.01 — Separate applicability dimensions
...
Тестовый artifact: `repo://super-ux/test/audit_regressions/fix-ux-15.01.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Развести information duty, legal basis, explicit consent и geography; убрать универсальный consent gate.
...
Одинаковый UI с разной applicability не получает один legal verdict автоматически.
...
Appendix и полный parent contract: [leaf JSON](FIX-UX-15.01.json), [parent](../parents/FIX-UX-15.json). Полный audit не required prompt input.
