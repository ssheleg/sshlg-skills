# FIX-RT-01.02 — Composition и отрицания
...
Тестовый artifact: `repo://sshlg-skills/test/audit_regressions/fix-rt-01.02.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.

## Шаги

1. Прочитать primary packet и проверить hash актуальных edit targets; upstream outputs materialize до claim.

2. Составлять route set по clauses; исключать agent-stack для простого использования subagent. Сохранять явные skill requests.
...
Subagent use не считается agent-system build; отрицание одной clause не стирает другую.

Positive и исходный failure case проверяются по поведению, не по повторению слов инструкции.

## Входы и handoff

- `FIX-RT-01.01` (data): Consumes the preceding contract/state/API decision described in this outcome.
...
Appendix и полный parent contract: [leaf JSON](FIX-RT-01.02.json), [parent](../parents/FIX-RT-01.json). Полный audit не required prompt input.
