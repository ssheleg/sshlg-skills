# FIX-DV-19.05 — Artifact eval: ad-tracking
...
### Create `repo://sheleg-dev/evals/cases/fix-dv-19.05.json`
...
Тестовый artifact: `repo://sheleg-dev/test/audit_regressions/fix-dv-19.05.py`. Это planned Create/extend; wiring в существующий runner принадлежит этой же правке.
...
2. Добавить offline artifact/fault-injection corpus ad-tracking, привязанный к соответствующим DV findings; protocol/provider stubs не являются oracle сами для себя.
...
Appendix и полный parent contract: [leaf JSON](FIX-DV-19.05.json), [parent](../parents/FIX-DV-19.json). Полный audit не required prompt input.
